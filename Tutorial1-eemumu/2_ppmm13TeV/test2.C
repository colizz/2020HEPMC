...
////*****************************************************************
    ...
    JJ=J1+J2;
    h1->Fill(JJ.M(), 843/10000.); 
    
////*****************************************************************
}

    cout<<h1->GetBinContent(0)<<" "<<h1->GetBinError(0)<<endl;
    cout<<h1->GetBinContent(1)<<" "<<h1->GetBinError(1)<<endl;
    cout<<h1->GetBinContent(2)<<" "<<h1->GetBinError(2)<<endl;
    //cout<<sqrt(h1->GetBinContent(2)/(843./10000.))*843/10000.<<endl;
    cout<<h1->GetBinContent(3)<<" "<<h1->GetBinError(3)<<endl;
...
cout<< h2->GetBinContent(4)<<" "<<h2->GetBinError(4)<<endl;
      ...
      c1->SetLogy();
      h1->SetTitle("#mu#mu at 13TeV LHC");
     ...
     TLegend *l1 = new TLegend(0.2,0.7,0.4,0.84);
     l1->SetBorderSize(1);
     l1->SetFillColor(0);
     l1->AddEntry(h1,"p p #rightarrow Z,#gamma  #rightarrow #mu#mu ");
     l1->AddEntry(h2,"p p #rightarrow #gamma #rightarrow #mu#mu ");
     l1->Draw();
     c1->SaveAs("Mmm.png");
